...
export default function StartupForm(){
    ...
    type FormState = {
        error: string;
        status: 'INITIAL' | 'SUCCESS' | 'ERROR'; // Use the specific statuses your state supports
    };
    ...
    const handleFormSubmit = async (prevState : FormState, formData : FormData) => {
        try{
            ...
            if(result.status === 'SUCCESS'){
                toast({
                    title: "Success",
                    description: "Your startups pitch has been created successfulyy",
                });
    ...
    return <form action={formAction} className="startup-form">
        ...
        <Button disabled={isPending} type="submit" className="startup-form_btn text-white">
            {isPending? 'Sumbitting your idea...' : 'Publish Your Startup'}
